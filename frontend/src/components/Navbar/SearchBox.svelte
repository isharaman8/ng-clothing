...
<div id="searchBox" class="absolute top-14 h-[80vh] max-sm:h-screen max-sm:pb-20 bg-white overflow-y-auto w-full rounded-md py-4">
    {#if noResult}
    ...
    <div class="w-full">
        {#each products as product}
            <a href={`/products/${product.uid}`}>
                <div class="flex px-4 py-2 items-center border-b-2 gap-4 cursor-pointer hover:bg-gray-100 hover:pl-5 hover:font-bold  transition-all duration-200">
